...
<footer className="bg-neutral-primary-soft">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="" className="flex items-center">
                  <img src={assets.logo} className="h-7 me-3" alt="FlowBite Logo" />
                  {/* <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">Flowbite</span> */}
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-primary">Resources</h2>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-primary ">Follow us</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase text-primary">Legal</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
      ...
      <hr className="my-10 border-default sm:mx-auto lg:my-8" />
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">Prescripto™</a>. All Rights Reserved.
          </span>
