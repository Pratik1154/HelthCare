        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="" class="flex items-center">
                  <img src={assets.logo} class="h-7 me-3" alt="FlowBite Logo" />
                  {/* <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">Flowbite</span> */}
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-heading uppercase text-primary">Resources</h2>
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-heading uppercase text-primary ">Follow us</h2>
                  <ul class="text-body font-medium">
                      <li class="mb-4">
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-heading uppercase text-primary">Legal</h2>
                  <ul class="text-body font-medium">
                      <li class="mb-4">
